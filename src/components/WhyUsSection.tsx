      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          <div className="animate-slide-up">
            <h2 className={`font-heading text-3xl sm:text-4xl lg:text-5xl text-foreground mb-8 ${
              language === 'ar' ? 'text-right' : ''
            }`}>
              {currentContent.title}
            </h2>
            <p className={`font-body text-lg sm:text-xl text-muted-foreground mb-16 leading-relaxed ${
              language === 'ar' ? 'text-right' : ''
            }`}>
              {currentContent.text}
            </p>
